...
def coordinate(final_expression):
    structure = parse(final_expression)
    return eval(structure)


print(coordinate('5 +@! (-6.3)'))                       # Error: Invalid operator "+@!"
# print(coordinate("1+2 * (3 + 4)"))          # 15
# print(coordinate("2+( (4div2)-3)"))         # 1.0
# print(coordinate("1.2add3-2.1"))            # 2.1
# print(coordinate("(5mod3)*2pow3"))          # 16
# print(coordinate("2 ^ (-2)"))               # 0.25
# print(coordinate("3+ (-2)"))                # 1